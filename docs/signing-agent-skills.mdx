...
1. Run SkillEvaluator, which runs SkillSpector on the Tier 1 scope documented in the [release checklist](/skills/release-checklist#tier-1-skillspector-scope).
2. Resolve or accept findings in that scope.
