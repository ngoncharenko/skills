...
|---|---|---|
| **Tier 1 — Validation** | Schema, license, PII, Unicode safety, and the SkillSpector security scan over a staged subset (artifact and evaluation trees excluded) | Yes, on high-severity findings in that scope |
